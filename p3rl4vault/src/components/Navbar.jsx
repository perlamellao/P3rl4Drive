                    ...
                    <nav className="nav">
                        <div> 
                            ...
                            <div className="nav_list"> 
                                <a onClick={() => handleActive(0)} className={getActive == 0 ? "nav_link active" : "nav_link"}> 
                                <   i className="bx bx-grid-alt nav_icon" /> 
                                    <span className="nav_name">Ajustes</span>
                                </a> 
                                <a onClick={() => handleActive(1)} className={getActive == 1 ? "nav_link active" : "nav_link"}>
                                    <i className="bx bx-message-square-detail nav_icon" />
                                    <span className="nav_name">Mensajes</span>
                                </a>
                                <a onClick={() => handleActive(2)} className={getActive == 2 ? "nav_link active" : "nav_link"}>
                                    <i className="bx bx-folder nav_icon" />
                                    <span className="nav_name">Archivos</span>
                                </a>
                                <a onClick={() => handleActive(3)} className={getActive == 3 ? "nav_link active" : "nav_link"}>
                                    <i className="bx bx-bar-chart-alt-2 nav_icon" />
                                    <span className="nav_name">Estatus</span>
                                </a>
                            </div>
                        </div> 
                        <a onClick={logout} className="nav_link"> <i className="bx bx-log-out nav_icon" /> <span className="nav_name">Cerrar Sesion</span> </a>
                    </nav>
                </div>
            </div>
        </div>
