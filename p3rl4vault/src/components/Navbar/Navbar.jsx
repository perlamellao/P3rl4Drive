    ...
    return (
        <div>
            ...
            <div className={toggleNav ? "l-navbar" : "l-navbar show"} id="nav-bar">
                <nav className="nav">
                    <div> 
                        <a className="nav_logo" href="/main">
                    ...
                    <a href="/#" onClick={logout} className="nav_link logout"> <i className="bx bx-log-out nav_icon" /> <span className="nav_name">Cerrar Sesion</span> </a>
                </nav>
            </div>
        </div>
    )
